...
import type { DefenseType, EnemyType } from './simulation';
...
export const ENEMY_DEFINITIONS: Record<EnemyType, EnemyDefinition> = {
	...
	memory_blob: {
		...
		name: 'Memory Blob',
		description:
			'A growing mass of unreleased memory that slows everything down',
		sprite: 'memory-blob',
		color: '#8b5cf6', // purple
		size: 'large',
		baseHp: 100,
		...
		railsSolution:
			'Use find_each for batching, avoid storing large datasets in memory',
...
export function getUnlockedDefenses(level: number): DefenseType[] {
	return (
		Object.entries(DEFENSE_DEFINITIONS) as [DefenseType, DefenseDefinition][]
	)
