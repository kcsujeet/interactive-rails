...
import type { Room, BossRoom, RoomObjective } from '../../types/level';
    ...
    <div className="bg-destructive/20 border border-destructive rounded-lg p-3 mb-4">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground">{room.bossDescription}</p>
        </div>
      </div>
      ...
      {room.briefing && (
        <div className="p-4 pt-0">
          <div className="bg-primary/20 border border-primary/50 rounded p-3">
            <h4 className="text-xs font-semibold text-primary mb-1">Briefing</h4>
      ...
      <div className="p-4 pt-0 border-t border-border">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <span className="text-xs text-muted-foreground">Available nodes:</span>
