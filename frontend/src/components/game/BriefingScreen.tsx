...
import type { LevelChallenge, LevelData } from './types';
...
export function BriefingScreen(
	props: BriefingScreenProps | LegacyBriefingScreenProps,
) {
					...
					{(challenge?.goal || level.goal) && (
						<div className="mt-4 flex gap-4 items-start bg-success/10 rounded-lg p-4 border border-success/20">
							...
							<div className="flex-1">
								...
								<p className="text-sm text-success-foreground leading-relaxed mt-1">
									{challenge?.goal || level.goal}
								</p>
							</div>
						</div>
						...
						<div className="mt-4 flex gap-3">
							<div className="flex-1 bg-card rounded-lg p-3 text-center border border-border">
								<div className="text-2xl font-semibold text-destructive tabular-nums">
									{challenge.initialMetrics.queries}
								</div>
							...
							<div className="flex-1 bg-card rounded-lg p-3 text-center border border-border">
								<div className="text-2xl font-semibold text-warning tabular-nums">
									{challenge.initialMetrics.latency}ms
								</div>
								<div className="text-[10px] text-muted-foreground uppercase tracking-wider mt-0.5">
									latency
								</div>
