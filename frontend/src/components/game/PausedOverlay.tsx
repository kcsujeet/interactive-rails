  ...
  return (
    <div className="absolute inset-0 bg-background/80 flex items-center justify-center z-20">
      <div className="bg-card rounded-xl border border-border p-8 text-center shadow-2xl">
        ...
        <h2 className="text-xl font-semibold text-foreground mb-5">Game Paused</h2>
        <div className="flex gap-3">
          <Button onClick={onResume} className="bg-success text-success-foreground hover:bg-success/90">
            Resume
          </Button>
