 ...
 *
 * This act covers the basics every Rails developer needs to know:
 * 1. Stack Choice - Choose your database
 * 2. Your First Model - Learn what models are
 * 3. CRUD Operations - Create, Read, Update, Delete
 * 4. Your First Controller - Handle HTTP requests
 * 5. Views & Templates - ERB syntax basics
 * 6. The MVC Pipeline - Connect everything together
 * 7. Persistence Layer - Save data to database
 * 8. Semantic Associations - Model relationships
 */
