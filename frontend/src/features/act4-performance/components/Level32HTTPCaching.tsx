...
export function Level32HTTPCaching({ onComplete }: LevelComponentProps) {
	...
	const handleComplete = async () => {
		const success = await completeLevel('act4-level32-http-caching', {
...
export default Level32HTTPCaching;
