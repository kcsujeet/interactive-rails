...
export function Level24N1Problem({ onComplete }: LevelComponentProps) {
	...
	const handleComplete = async () => {
		const success = await completeLevel('act4-level24-n1-problem', {
			stars: 3,
		});
		if (success) {
			onComplete({ stars: 3 });
...
export default Level24N1Problem;
