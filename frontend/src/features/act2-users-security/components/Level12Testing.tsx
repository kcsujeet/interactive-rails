...
export function Level12Testing({ onComplete, onExit }: LevelComponentProps) {
	...
	const handleComplete = async () => {
		const success = await completeLevel('act2-level12-testing', {
			stars: 3,
		});
		if (success) {
			onComplete({ stars: 3 });
