...
const level22N1Problem: Level = {
	...
	startingPipeline: {
		nodes: [
			...
			{ id: 'controller-node', type: 'controller', x: 420, y: 250, locked: true },
			{ id: 'post-model', type: 'model', x: 640, y: 140, locked: true, config: { label: 'Post' } },
			{ id: 'author-model', type: 'model', x: 640, y: 360, locked: true, config: { label: 'User' } },
			{ id: 'database-node', type: 'database', x: 860, y: 250, locked: true },
			{ id: 'serializer-node', type: 'serializer', x: 420, y: 460, locked: true },
			{ id: 'response-node', type: 'response', x: 640, y: 460, locked: true },
		],
		connections: [
...
const level25CounterCaches: Level = {
	...
	startingPipeline: {
		nodes: [
			...
			{ id: 'controller-node', type: 'controller', x: 420, y: 250, locked: true },
			{ id: 'post-model', type: 'model', x: 640, y: 140, locked: true, config: { label: 'Post' } },
			{ id: 'comment-model', type: 'model', x: 640, y: 360, locked: true, config: { label: 'Comment' } },
			{ id: 'database-node', type: 'database', x: 860, y: 250, locked: true },
			{ id: 'serializer-node', type: 'serializer', x: 420, y: 460, locked: true },
			{ id: 'response-node', type: 'response', x: 640, y: 460, locked: true },
		],
