...
const level9Validations: Level = {
	...
	startingPipeline: {
		nodes: [
			...
			{ id: 'auth-node', type: 'authentication', x: 240, y: 220, locked: true },
			{ id: 'router-node', type: 'router', x: 400, y: 220, locked: true },
			{ id: 'controller-node', type: 'controller', x: 560, y: 220, locked: true },
			{ id: 'post-model', type: 'model', x: 740, y: 220, locked: true, config: { label: 'Post' } },
			{ id: 'database-node', type: 'database', x: 920, y: 220, locked: true },
			{ id: 'serializer-node', type: 'serializer', x: 560, y: 420, locked: true },
...
const level10Callbacks: Level = {
	...
	startingPipeline: {
		nodes: [
			...
			{ id: 'auth-node', type: 'authentication', x: 240, y: 250, locked: true },
			{ id: 'router-node', type: 'router', x: 400, y: 250, locked: true },
			{ id: 'controller-node', type: 'controller', x: 560, y: 250, locked: true },
			{ id: 'user-model', type: 'model', x: 760, y: 140, locked: true, config: { label: 'User' } },
			{ id: 'post-model', type: 'model', x: 760, y: 360, locked: true, config: { label: 'Post' } },
			{ id: 'database-node', type: 'database', x: 960, y: 250, locked: true },
			{ id: 'response-node', type: 'response', x: 560, y: 450, locked: true },
		],
		connections: [
			{ id: 'c1', sourceNodeId: 'request-node', targetNodeId: 'auth-node' },
			{ id: 'c2', sourceNodeId: 'auth-node', targetNodeId: 'router-node' },
...
const level11Authorization: Level = {
	...
	startingPipeline: {
		nodes: [
			{ id: 'request-node', type: 'request', x: 80, y: 250, locked: true },
			{ id: 'auth-node', type: 'authentication', x: 180, y: 250, locked: true },
			{ id: 'router-node', type: 'router', x: 300, y: 250, locked: true },
			{ id: 'controller-node', type: 'controller', x: 440, y: 250, locked: true },
			{ id: 'post-model', type: 'model', x: 620, y: 250, locked: true, config: { label: 'Post' } },
			{ id: 'database-node', type: 'database', x: 780, y: 250, locked: true },
			{ id: 'serializer-node', type: 'serializer', x: 620, y: 400, locked: true },
...
const level12Testing: Level = {
	...
	startingPipeline: {
		nodes: [
			...
			{ id: 'router-node', type: 'router', x: 400, y: 220, locked: true },
			{ id: 'controller-node', type: 'controller', x: 560, y: 220, locked: true },
			{ id: 'policy-node', type: 'policy', x: 560, y: 80, locked: true },
			{ id: 'post-model', type: 'model', x: 760, y: 220, locked: true, config: { label: 'Post' } },
			{ id: 'database-node', type: 'database', x: 960, y: 220, locked: true },
			{ id: 'serializer-node', type: 'serializer', x: 560, y: 420, locked: true },
			{ id: 'response-node', type: 'response', x: 760, y: 420, locked: true },
		],
		connections: [
			{ id: 'c1', sourceNodeId: 'request-node', targetNodeId: 'auth-node' },
			{ id: 'c2', sourceNodeId: 'auth-node', targetNodeId: 'router-node' },
...
const level14ScopesEnums: Level = {
	...
	startingPipeline: {
		nodes: [
			{ id: 'request-node', type: 'request', x: 80, y: 220, locked: true },
			{ id: 'cors-node', type: 'cors', x: 220, y: 220, locked: true },
			{ id: 'auth-node', type: 'authentication', x: 360, y: 220, locked: true },
			{ id: 'router-node', type: 'router', x: 500, y: 220, locked: true },
			{ id: 'controller-node', type: 'controller', x: 640, y: 220, locked: true },
			{ id: 'policy-node', type: 'policy', x: 640, y: 80, locked: true },
			{ id: 'post-model', type: 'model', x: 820, y: 220, locked: true, config: { label: 'Post' } },
			{ id: 'database-node', type: 'database', x: 1000, y: 220, locked: true },
			{ id: 'serializer-node', type: 'serializer', x: 640, y: 420, locked: true },
			{ id: 'response-node', type: 'response', x: 820, y: 420, locked: true },
		],
		connections: [
