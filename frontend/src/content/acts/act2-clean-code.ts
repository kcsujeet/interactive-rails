...
const level9Security: Level = {
  ...
  trigger: {
    type: 'incident',
    description: 'Security audit failed. Credentials are exposed in the codebase.',
  },
...
Rails.application.credentials.dig(:database, :password)`,
    ...
    furtherReading: [{ title: 'Rails Security Guide', url: 'https://guides.rubyonrails.org/security.html' }],
  },
...
const level10Scopes: Level = {
  ...
  trigger: {
    type: 'code_review',
    description: 'Query logic is scattered across controllers. Time to consolidate.',
  },
  startingPipeline: { nodes: [], connections: [] },
  problem: {
...
Post.published.recent.by_author(current_user)`,
    ...
    furtherReading: [{ title: 'ActiveRecord Query Interface', url: 'https://guides.rubyonrails.org/active_record_querying.html' }],
  },
...
def create
  ...
  if result.success?
    ...
    furtherReading: [{ title: 'SOLID Principles', url: 'https://en.wikipedia.org/wiki/SOLID' }],
  },
...
class UserRegistration
  ...
  def call
    ...
    furtherReading: [{ title: 'Service Objects', url: 'https://www.toptal.com/ruby-on-rails/rails-service-objects-tutorial' }],
  },
  hint: { delay: 20, text: 'Create a service class with a single call method.' },
};
...
const level13FormObjects: Level = {
  ...
  trigger: {
    type: 'new_feature',
    description: 'Registration form creates both User and Company. How do we validate?',
  },
  startingPipeline: { nodes: [], connections: [] },
  problem: {
...
class RegistrationForm
  ...
  def save
    ...
    commonMistakes: ['Validations in controller', 'accepts_nested_attributes abuse'],
    whenToUse: 'Forms that create/update multiple models.',
    furtherReading: [{ title: 'Form Objects', url: 'https://thoughtbot.com/blog/activemodel-form-objects' }],
  },
...
const level14Authorization: Level = {
  ...
  trigger: {
    ...
    description: 'Users can edit posts they do not own. Authorization is broken.',
  },
  startingPipeline: { nodes: [], connections: [] },
  problem: {
...
def update
  ...
  @post.update(post_params)
    ...
    furtherReading: [{ title: 'Pundit', url: 'https://github.com/varvet/pundit' }],
  },
...
const level15ViewComponents: Level = {
  ...
  trigger: {
    type: 'code_review',
    description: 'Same partial rendered in 12 places with different logic. Refactor time.',
  },
  startingPipeline: { nodes: [], connections: [] },
  problem: {
...
<%= render(PostCardComponent.new(post: @post, show_admin_badge: current_user.admin?)) %>`,
    ...
    furtherReading: [{ title: 'ViewComponent', url: 'https://viewcomponent.org/' }],
  },
  hint: { delay: 20, text: 'Create a component class extending ViewComponent::Base.' },
};
...
export const actTwo: Act = {
  ...
  description: 'Learn patterns for clean, maintainable Rails code: services, form objects, policies, and components.',
  levels: [
    level9Security,
    level10Scopes,
