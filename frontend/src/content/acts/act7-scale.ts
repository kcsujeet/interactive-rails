			...
			options: [
				{
					...
					consequence: 'Battle-tested gem, excellent Rails integration',
					correct: true,
				},
				{
					label: 'Plain enum',
					...
					consequence: 'No transition guards — same problem as a string column',
					correct: false,
				},
				{
					label: 'Statesman',
					...
					consequence: 'Good choice, but AASM is more widely adopted',
					correct: false,
				},
			],
		},
