...
const room1: Room = {
  ...
  timeLimit: 15,
  successMessage: 'You saw the problem! Full table scans are devastating at scale.',
};
...
const room3: Room = {
  ...
  initialNodes: [
    ...
    { type: 'controller', position: { x: 400, y: 300 }, locked: false },
    {
      type: 'model',
      position: { x: 550, y: 300 },
      config: { name: 'User', queries: ['WHERE status = ? AND created_at > ?'] },
      locked: false,
    },
    {
      type: 'database',
