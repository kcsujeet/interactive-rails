...
import type { Dungeon, Room, BossRoom } from '../../types/dungeon';

const room1: Room = {
  id: 'nplusone-observe',
  name: 'Observe the Problem',
  description: 'Watch the pipeline run and observe the N+1 query pattern in action.',
  briefing: `
  ...
  timeLimit: 15,
  successMessage: 'You observed the N+1 pattern! Notice how each Post generates an extra Author query.',
};
...
const bossRoom: BossRoom = {
  ...
  description: 'Face the Query Hydra - a boss that spawns from deeply nested N+1 patterns.',
  briefing: \`
  ...
  availableDefenses: ['cache_shield', 'index_turret', 'eager_loader', 'rate_limiter'],
  stabilityThreshold: 80,
  bossType: 'query_swarm',
  bossName: 'The Query Hydra',
  bossDescription: 'A many-headed beast that multiplies with each nested N+1 query.',
  bossHp: 500,
  phases: [
    {
      hpThreshold: 75,
  ...
  successMessage: 'You defeated the Query Hydra! The N+1 menace has been vanquished!',
  failureMessage: 'The Query Hydra overwhelmed your system. Try optimizing more aggressively!',
};

export const tutorialNPlusOne: Dungeon = {
