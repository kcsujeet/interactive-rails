...
registerLevelCode('act5-level36-background-jobs', () =>
...
export function Level36BackgroundJobs({ onComplete }: LevelComponentProps) {
...
export default Level36BackgroundJobs;
