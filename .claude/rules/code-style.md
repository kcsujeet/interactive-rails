...
- **Always follow the Rules of React.** Biome does not enforce React-specific rules (hooks ordering, key usage, etc.). Verify manually. Reference: https://react.dev/reference/rules
