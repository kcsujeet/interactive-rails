...
-- Player progress (simplified)
-- Stores level, XP, and unlocked content
...
-- Stores best performance for each dungeon
...
-- Stores detailed metrics from notable completions
...
-- Top 100 per dungeon, refreshed periodically
