...
import { realms, getDungeonChallenges, getChallenge } from '../services/content';
import { ProgressRepository } from '../repositories/progressRepository';
import { NotFoundError, InternalError } from '../errors';
import { logger } from '../utils/logger';
import type { Env, DungeonProgress } from '../types';
...
gameRoutes.get('/realms/:realmId/dungeons', authMiddleware, async (c) => {
  ...
  const dungeonProgress = await progressRepo.getDungeonProgress(userId, realmId);
